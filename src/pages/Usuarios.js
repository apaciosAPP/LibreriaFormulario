...
export const Usuarios = () => {
  return (
    <>
      <ContainerContent className="app-content">
        <ContainerHeaderContent className="app-content-header">
          <h1 className="app-content-headerText">Usuarios</h1>
          ...
          <ContainerAccountUser className="account-info">
            <Avatar className="account-info-picture">
              <img
          ...
          <button className="app-content-headerButton">Agregar Usuario</button>
        </ContainerHeaderContent>
        ...
        <div className="products-area-wrapper tableView">
          ...
          <div className="products-row">
            ...
            <div className="product-cell category">
              <span className="cell-label">Apellidos</span>Gonzales Abarca
            </div>
            <div className="product-cell status-cell">
            ...
            <div className="product-cell sales">
              <span className="cell-label">Correo@:</span>correo@correo.com
            </div>
            <div className="product-cell stock">
              <span className="cell-label">Dirrecion:</span> calle 37 #5622
            </div>
            <div className="product-cell price">
              <button className="filter-button reset">Edit</button>
              <button className="filter-button apply">Delete</button>
            </div>
          </div>
        </div>
      </ContainerContent>
